  ...
  return (
    ...
    >
      ...
      <ul>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Marvelversed, accessible from{" "}
            <a
              href="https://www.marvelversed.com"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://www.marvelversed.com
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>
          <p>By email: rectrix21@gmail.com</p>
        </li>
        <li>
          <p>
            By visiting this page on our website:{" "}
            <a
              href="https://www.marvelversed.com/contact"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://www.marvelversed.com/contact
            </a>
          </p>
        </li>
      </ul>
